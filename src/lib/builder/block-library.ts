...
export const builderBlockLibrary: BuilderBlockDefinition[] = [
  {
    ...
    defaultNode: {
      ...
      content: {
        ...
        menuTextColor: '#4b4038',
        menuLinkColor: '#6f6659',
        menuLinkBorderColor: 'rgba(196,145,45,0.28)',
        menuCtaBackgroundColor: '#f2c86b',
        menuCtaTextColor: '#140e0a',
  ...
  },
  {
    ...
    defaultNode: {
      ...
      content: {
        ...
        productTag: '',
        productTagStyle: 'tiles',
        productTagAllLabel: 'Todas',
  ...
  {
    type: 'product_promo_rail',
    label: 'Carrusel de promociones',
    description: 'Vitrina comercial filtrada por etiqueta: promociones, regalos, lanzamientos o más vendidos.',
    category: 'products',
    icon: 'badge-percent',
    defaultNode: {
      type: 'product_promo_rail',
      ...
      content: {
        eyebrow: 'Promociones Amantra',
        title: 'Ofertas para llevar bienestar contigo',
        subtitle: 'Promo',
        body: 'Selecciona una etiqueta comercial para mostrar solo productos de esa campaña con una vitrina más vendedora.',
        productTag: 'promociones',
